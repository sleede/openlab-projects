class ProjectsTest < ActionDispatch::IntegrationTest
  ...
  test "projects#update success" do
    ...
    patch "#{api_v1_projects_path}/#{project.project_id}", params: {
        project: {
          name: "Awesome project",
        }
      }.to_json,
  ...
  test "projects#update return http status code 404 if project not found" do
    patch "#{api_v1_projects_path}/9876511321", params: { }, headers: default_headers(api_client: @api_client)
  ...
  test "projects#destroy" do
    project = Project.all.first
    delete "#{api_v1_projects_path}/#{project.project_id}", headers: default_headers(api_client: @api_client)
